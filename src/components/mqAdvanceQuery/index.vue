<template>
  <div
    v-if="model === 'advance'"
    v-permission="permissionQuery"
    class="advance-query-form"
  >
    <slot name="form"></slot>
  </div>
  <a-divider
  ...
  <div class="advance-query-btn">
    ...
    <div class="advance-query-btn__right">
      <a-space fill>
        ...
        <a-button v-permission="permissionQuery" type="primary" @click="onQuery"
          >查询</a-button
        >
        <a-button v-permission="permissionQuery" @click="onResetQuery"
          >重置</a-button
        >
